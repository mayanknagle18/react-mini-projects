            ...
            <div className="bw_container">
                <div className="bw_cont_wrap">
                    ...
                    <div className="bw_clock_list">
                        ...
                        <h5>{currentData.toLocaleString("en-US", {hour: "numeric", minute: "2-digit", second: "2-digit", hour12: true,})} AM</h5>
                    </div>
                    <div className="bw_clock_list">
                        <h4>24 Hour Format:</h4>
                        <h5>{currentData.getHours()}:{String(currentData.getMinutes()).padStart(2, "0")}:{String(currentData.getSeconds()).padStart(2, "0")} AM</h5>
                    </div>
                </div>
            </div>
        </div>
